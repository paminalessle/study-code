...
//make class player abstract
//create a class for a non injured player or make "injured" a zustand that gets checked for training
...
//auflösen dieses interfaces und weitere aufteilung in kleinere
...
private:
    ...
    FilePlayerRepository repository;  //repository and notifier in a seperate interface that
                                      //the football manager inherits from. then use refrences
